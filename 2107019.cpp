...
public:
    ...
    void add()
    {
        ...
        cout<<"The vehicle no of your allocated Ambulance is : "<<A1[vehicle_count].getno()<<endl;
        vehicle_count++;
    }
    ...
    void rent()
    {
        ...
        int ctr=0;
        if(vehicle_count==0)
            cout<<"No Ambulances registered Yet"<<endl;
        ...
        else
        {
            ...
            for(int i=0; i<vehicle_count; i++)
            {
                if(A1[i].getLocation()==l)
                {
                    if(A1[i].getavail()==1)
                    {
                        cout<<"An Ambulance of "<<A1[i].getno()<<" will be at your service"<<endl;
                        ctr++;
                        A1[i].setavail(0);
                        break;
                    }
            ...
            if(ctr==0)
            {
                ...
                for(int i=0; i<vehicle_count; i++)
                {
                    if(A1[i].getavail()==1)
                    {
                        cout<<"An ambulance from "<<A1[i].getLocation()<<"Vehicle NO:"<<A1[i].getno()<<" will come"<<endl;
                        A1[i].setavail(0);
                        c++;
                ...
                if(c==0)
                {
                    cout<<"Ambulance unavailable for now.";
                }
    ...
    {
        if(vehicle_count==0)
            cout<<"No Ambulances registered Yet";
        else
        {
            int n;
        ...
        else
        {
            ...
            for(int i=0; i<vehicle_count; i++)
            {
                if(n==A1[i].getno() && A1[i].getavail()==1)
                {
                    ...
                    A1[i].setavail(0);
                    cout<<"The Ambulance is being repaired."<<endl;
                    m1++;
                    break;
                }
            }
            if(m1==0)
                cout<<"The ambulance is not available for repairing"<<endl;
        }
    }
    friend void a_status(AmbulanceManagement a);
};
...
public:
    ...
    void policeDetails()
    {
        cout<<"Police Unit NO:"<<unit_no<<" of "<<pers<<" members in the area of "<<area<<" Availability status:"<<avail<<endl;
    }
...
public:
    ...
    void clpolice()
    {
        ...
        cin>>s;
        cout<<"Enter your emergency:"<<endl;
        ...
        {for(int i=0; i<total_un; i++)
        {
            if(p1[i].getarea()==s)
            {
                ...
                else if(n==1||n==3) cout<<"The unit of "<<s<<" is a little busy right now keep safe and wait for a bit "<<endl;
                else if(n==2)
                {
                    int r=0;
                    ...
                    if(r==0)
                    {
                        cout<<"A police unit will contact you as soon as they are available...Don't be panicked too much!";
                    }
                }
            }
        }
    ...
    void repair()
    {
        ...
        {
            cout<<"Enter the Unit No. of the Police:";
            cin>>n;
            for(int i=0; i<total_un; i++)
            {
        ...
        else
        {
            ...
            for(int i=0; i<unit_cn; i++)
            {
                if(n==F1[i].get_unit()&&F1[i].getavail()==1)
                {
                    F1[i].setavail(0);
                    c++;
                    cout<<"The unit "<<n<<"is out of service due to maintenance."<<endl;
                    break;
                }
            }
            if(c==0)
...
void f_status(FSManagement a)
{
     int i;
    if(a.unit_cn==0)
        cout<<"No vehicle is registered yet."<<endl;
    else
    {
...
int main()
{
    ...
    do
    {
        cout<<"For Ambulance Press 1"<<endl<<"For Police Press 2"<<endl<<"Give 3 for Fire Service"<<endl<<"Now give the option:";
        cin>>n;
        if(n==1)
        {
            cout<<"Give 1 for calling an ambulance "<<endl<<"Give 2 for entering management system"<<endl<<"Now give the option:";
            int m;
            cin>>m;
            if(m==1)
            {
            ...
            {
                int n1;
                cout<<"Give 1 to add,2 to show details for a specific unit,3 to repair,4 to show all data:";
                cin>>n1;
                if(n1==1)
                {
                    a1.add();
        ...
        if(n==2)
        {
            ...
            cout<<"Give 1 for calling Police force"<<endl<<"Give 2 for entering management system"<<endl<<"Now enter the option:";
            int m;
            cin>>m;
            if(m==1)
            {
            ...
            if(m==2)
            {
                cout<<"Give 1 to add,2 to show details,3 to send out of service,4 to show all data:";
                int n1;
                cin>>n1;
                if(n1==1)
                {
        ...
        if(n==3)
        {
            cout<<"Give 1 for calling Fire Service"<<endl<<"Give 2 for entering management system"<<endl<<"Now give the option:";
            int m;
            cin>>m;
            if(m==1)
            {
            ...
            if(m==2)
            {
                cout<<"Give 1 to add,2 to show det,3 to repair,4 to show all data:";
                int n1;
                cin>>n1;
                if(n1==1)
                {
